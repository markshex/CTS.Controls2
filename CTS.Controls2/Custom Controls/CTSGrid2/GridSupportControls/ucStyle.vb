Public Class ucStyle
    ...
    Public Sub LoadModel()
        ...
        inpName.Value = DS.Name
        inpTestColumn.Value = DS.FieldName
        inpTestOp.Value = DS.Op
        inpTestValue.Value = DS.Value
        inpApplyType.Value = DS.ApplyType
        inpApplyColumn.Value = DS.ApplyCellName
    ...
    Public Sub Mapping()
        ...
        Try
            ...
            DS.Name = inpName.Value
            DS.FieldName = inpTestColumn.Value
            DS.Op = inpTestOp.Value
            DS.Value = inpTestValue.Value
            DS.ApplyType = inpApplyType.Value
            DS.ApplyCellName = inpApplyColumn.Value
